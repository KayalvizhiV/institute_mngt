...
def main():
    ...
    result = converter.convert_schema(simple_table)
    print(result)
    print("\n" + "="*50 + "\n")
    
    # More complex single table
    complex_single_table = """
    CREATE TABLE `users` (
    ...
    print("Testing complex single table:")
    print("=" * 35)
    result2 = converter.convert_schema(complex_single_table)
    print(result2)
