...
class MySQLToMSSQLConverter:
    ...
    def parse_mysql_schema(self, schema: str) -> List[TableDefinition]:
        ...
        # Find all CREATE TABLE statements - made semicolon optional and more flexible
...
def main():
    ...
    # Example single table MySQL schema (without semicolon)
    single_table_schema = """
    CREATE TABLE `users` (
    ...
    mssql_schema = converter.convert_schema(single_table_schema)
    
    print("Single Table Conversion Result:")
    print("=" * 50)
    print(mssql_schema)
    
    print("\n" + "="*50 + "\n")
    
    # Example with multiple tables (original example)
    multiple_tables_schema = """
    CREATE TABLE `users` (
      `id` int(11) NOT NULL AUTO_INCREMENT,
      `username` varchar(50) NOT NULL,
      `email` varchar(100) NOT NULL,
    ...
    mssql_multiple = converter.convert_schema(multiple_tables_schema)
    
    print("Multiple Tables Conversion Result:")
    print("=" * 50)
    print(mssql_multiple)
